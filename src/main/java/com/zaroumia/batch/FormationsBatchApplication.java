...
public class FormationsBatchApplication implements CommandLineRunner {
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		JobParameters params = new JobParametersBuilder()
				.addString("formateursFile", args[0])
				.addString("formationsFile", args[1])
				.addString("seancesFile", args[2])
